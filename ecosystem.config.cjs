  ...
  apps: [
    {
      ...
      env: {
        ...
        // ── SECRETS ── Do NOT put real values here. Set these in the VPS shell
        //              environment before running `pm2 reload ecosystem.config.cjs`.
        //
        //   export DATABASE_URL="postgres://..."
        //   export SESSION_SECRET="<random-32-char-string>"
        //   export VAPID_PRIVATE_KEY="<your-vapid-private-key>"
        //
        // PM2 will pick them up from the shell when you run:
        //   pm2 reload ecosystem.config.cjs --update-env
      },
